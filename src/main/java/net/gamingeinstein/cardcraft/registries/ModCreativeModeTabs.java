    ...
    public static final RegistryObject<CreativeModeTab> CARDCRAFT_TAB = CREATIVE_MODE_TABS.register("cardcraft_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.BASE_TRADING_CARD.get()))
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(ModItems.BAT_TRADING_CARD.get());
                        ...
                        pOutput.accept(ModItems.ENDERMAN_TRADING_CARD.get());
                        ...
                        pOutput.accept(ModItems.MULE_TRADING_CARD.get());
                        ...
                        pOutput.accept(ModItems.SKELETON_HORSE_TRADING_CARD.get());
                        ...
                        pOutput.accept(ModItems.ZOMBIE_HORSE_TRADING_CARD.get());
